  ...
  return (
        <article className={`${color} relative flex flex-col rounded-xl h-[260px] md:h-[420px] w-80% md:w-full overflow-hidden group shadow-md`}>
            ...
            <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-between">
                <a href={project.link} target="_blank" className="flex items-center w-1/2 mx-auto justify-center hover:bg-black/70 ">
                ...
                <a href={project.github} target="_blank" className="flex items-center w-1/2 mx-auto justify-center hover:bg-black/70">
