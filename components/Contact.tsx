    ...
    return (
        <div className="bg-gradient-to-br from-[#2D2E32]">
            <div className="h-screen container mx-auto">
                <motion.h3
                    className="uppercase tracking-[12px] text-white text-4xl absolute mt-[5%] mx-auto font-extrabold"
                    initial={{ opacity: 0 }}
                ...
                <motion.div
                    className="grid lg:grid-cols-2 h-full content-center pb-32 lg:pb-0"
                    initial={{ y: 0, opacity: 0 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}>
                    <motion.div
                        className="space-y-6 md:space-y-10 mx-auto lg:mx-0"
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 1, delay: 0.6 }}>
                        <h4 className="text-xl md:text-3xl font-semibold">
                            <span className="text-[#64F4AC] font-bold">
                                Don&apos;t be shy.{" "}
                            </span>
                    ...
                    <motion.form
                        action="https://formsubmit.co/denis.kosogov@gmail.com"
                        method="POST"
                        className="flex flex-col space-y-2 w-fit mx-auto mt-6 md:mt-16 lg:mt-0"
                        ...
                        <button
                            type="submit"
                            className="button-style py-4 rounded-md text-white font-bold text-lg">
                            Submit
                        </button>
                    </motion.form>
                </motion.div>
                <div className="w-full absolute top-[80%] bg-[#059669]/5 left-0 h-[450px] skew-y-3">
                    <div className="space-y-2 text-white font-normal text-center flex flex-col -skew-y-3 items-center justify-center h-2/6 md:h-1/2">
                        <p className="text-xs md:text-base">
                            <span className="font-sans text-md">&copy;</span>{" "}
                            2023{" "}
                            <span className="font-black">Denis Kosogov</span>.
                            All rights reserved.
                        </p>
                        <p className="text-xs md:text-base">
                            Built with ❤️ in Toronto, ON
                        </p>
                    </div>
                </div>
            </div>
