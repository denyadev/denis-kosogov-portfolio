    ...
    return (
        <div className="bg-[#25262A]">
            <div className="h-screen container mx-auto">
                <h3 className="uppercase tracking-[12px] text-white text-4xl absolute mt-[5%] mx-auto font-extrabold">
                    About
                </h3>
                <div className="grid lg:grid-cols-2 h-full content-center gap-12">
                    ...
                    <motion.div
                        className="space-y-8 px-0 md:px-10 md:order-last"
                        initial={{ opacity: 0, y: 100 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 1, delay: 0.6 }}>
                        <p className="text-[#64F4AC] text-base md:text-lg">
                            Introduction
                        </p>
                        <h4 className="text-2xl md:text-4xl lg:text-5xl font-normal">
                            Here is a{" "}
                            <span className="underline decoration-[#64F4AC]">
                                little
                            </span>{" "}
                            background
                        </h4>
