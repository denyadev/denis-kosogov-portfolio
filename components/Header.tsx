    ...
    return (
        <header className={navbar ? 'header-active' : 'header'}>
            <div className="container flex justify-between items-center mx-auto py-4 text-[#fefefe] text-lg font-bold">
                <p onClick={() => fullpage.moveTo(1)} className="text-3xl md:inline-flex tracking-tighter text-white cursor-pointer">denya<span className="font-normal text-[#64F4AC]">.dev</span></p>
                <motion.div className="hidden xl:flex  flex-row items-center text-gray-300 cursor-pointer" 
                ...
                transition={{ duration: 1.5 }}>
                    <div className="space-x-16">
                        ...
                        <p onClick={() => fullpage.moveTo(3)} className="hidden md:inline-flex text-sm text-white font-normal hover:text-[#64F4AC]">portfolio:</p>
                        <p onClick={() => fullpage.moveTo(4)} className="hidden md:inline-flex text-sm text-white font-normal hover:text-[#64F4AC]">contact me:</p>
                    </div>
                </motion.div>
                <motion.div className="flex flex-row items-center gap-8"
                initial={{ x: -500, opacity: 0, scale: 0.5 }}
                animate={{ x: 0, opacity: 1,  scale: 1}}
                transition={{ duration: 1.5 }}>
                    {/* Socials */}
            ...
            <div className="lg:hidden flex flex-col">
                <p onClick={() => fullpage.moveTo(2)} className="inline-flex text-sm text-white font-normal hover:text-[#64F4AC] p-8 bg-black/70 w-full justify-end">about:</p>
                <p onClick={() => fullpage.moveTo(3)} className="inline-flex text-sm text-white font-normal hover:text-[#64F4AC] p-8 bg-black/70 w-full justify-end">portfolio:</p>
                <p onClick={() => fullpage.moveTo(4)} className="inline-flex text-sm text-white font-normal hover:text-[#64F4AC] p-8 bg-black/70 w-full justify-end">contact me:</p>
            </div>
        }
        </header>
  )
