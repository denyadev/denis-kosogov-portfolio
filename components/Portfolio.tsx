...
const Portfolio = (props: Props) => {
  return (
    <div className="bg-[#25262A]">
        <motion.div className="container h-screen mx-auto grid lg:grid-cols-2 gap-8 items-center"
        initial={{ opacity: 0 }}
        ...
        <div className="grid grid-rows-4">
            ...
            <div className='row-span-2'>
                ...
                transition={{ duration: 1 }}>
                    <ProjectCard project={projects[0]} color={'bg-gradient-to-bl from-[#16191E] to-emerald-500/5'}/>
                </motion.div>
        ...
        <div className="grid grid-rows-4 gap-8">
            ...
            <motion.div
                ...
                whileInView={{ x: 0, y: 0 }}
                transition={{ duration: 1 }}>
                <ProjectCard project={projects[1]} color={'bg-gradient-to-bl from-[#2d3037] to-black/50'}/>
            </motion.div>
            </div>
            <div className='row-span-2'>
            <motion.div
                ...
                whileInView={{ x: 0 }}
                transition={{ duration: 1 }}>
                <ProjectCard project={projects[2]} color={'bg-gradient-to-br from-[#181A2D] to-black/90'}/>
            </motion.div>
            </div>
        </div>
